...
export type Stage = 'lead' | 'follow_up' | 'won' | 'lost' | 'didnt_answer';

export const STAGE_ORDER: Stage[] = ['lead', 'follow_up', 'won', 'lost', 'didnt_answer'];
...
export const STAGE_COLUMN: Record<Stage, { header: string; bg: string }> = {
  ...
  won: { header: 'text-green-600', bg: 'bg-green-50' },
